    ...
    <>
      <header className="border-b border-slate-800 bg-slate-900/60 backdrop-blur-md sticky top-0 z-30 px-4 sm:px-6 py-3.5">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          {/* Botão de Busca Rápida + Perfil da Usuária e Logout */}
          <div className="flex items-center gap-3 sm:gap-4">
            ...
            >
              ...
              <kbd className="hidden lg:inline-flex px-1.5 py-0.5 bg-slate-800 text-slate-400 rounded text-[10px] font-mono border border-slate-700">
                Ctrl+K
              </kbd>
            </button>
